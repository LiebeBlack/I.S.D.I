...
class _Level1ScreenState extends ConsumerState<Level1Screen> {
  ...
  Widget _buildHeader(int step) => Padding(
      ...
      child: Row(
        children: [
          ...
          Text(
            ...
            style: DynamicThemingEngine.labelStyle.copyWith(
      ...
      child: Column(
        ...
        children: [
          Text(
            ...
            style:
                DynamicThemingEngine.displayStyle.copyWith(color: IslaColors.oceanDark),
            textAlign: TextAlign.center,
          ...
          GlassContainer(
            child: Text(
              ...
              textAlign: TextAlign.center,
              style:
                  DynamicThemingEngine.subtitleStyle.copyWith(color: IslaColors.charcoal),
            ),
