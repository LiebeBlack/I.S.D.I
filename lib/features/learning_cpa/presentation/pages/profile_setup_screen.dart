...
class _ProfileSetupScreenState extends ConsumerState<ProfileSetupScreen> {
  ...
  Future<void> _saveProfile() async {
    ...
    // Feature 13: Strict Regex Input Sanitization
    final nameRegex = RegExp(r'^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]{2,15}$');
    if (!nameRegex.hasMatch(name)) {
      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('El nombre solo debe contener letras (2-15 caracteres)'),
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
              content: Text('Error al crear perfil. Intenta de nuevo.')),
        );
      }
    }
  }
  ...
  Widget _buildAvatarGrid() => GlassContainer(
    child: Column(
      children: [
  ...
  Widget _buildFormSection() => GlassContainer(
    child: Column(
      ...
      children: [
        ...
        TextField(
          ...
          maxLength: 12,
          inputFormatters: [
            // Bloquear emojis y caracteres extraños en tiempo real
          ...
          decoration: InputDecoration(
            ...
            counterText: '',
            prefixIcon:
                const Icon(Icons.star_rounded, color: IslaColors.sunflower),
            filled: true,
        ...
        const Text('¿CUÁNTOS AÑOS TIENES?',
            style: TextStyle(
                fontWeight: FontWeight.w900,
                fontSize: 16,
                color: IslaColors.oceanDark)),
